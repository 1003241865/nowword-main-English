...
public class SockScreenActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener{
    ...
    private void setword(Word word) {
        ...
        switch (r) {
            case 0:
                radioOne.setText(Tran_CN_split.getspit(word.getTranCN()));
                radioTwo.setText(Tran_CN_split.getspit(worrywords.get(0).getTranCN()));
                radioThree.setText(Tran_CN_split.getspit(worrywords.get(1).getTranCN()));
                radioFour.setText( Tran_CN_split.getspit(worrywords.get(2).getTranCN()));
                break;
            case 1:
                radioOne.setText( Tran_CN_split.getspit(worrywords.get(0).getTranCN()));
                radioTwo.setText(Tran_CN_split.getspit(word.getTranCN()));
                radioThree.setText(Tran_CN_split.getspit(worrywords.get(1).getTranCN()));
                radioFour.setText(Tran_CN_split.getspit(worrywords.get(2).getTranCN()));
                break;
            case 2:
                radioOne.setText(Tran_CN_split.getspit(worrywords.get(1).getTranCN()));
                radioTwo.setText(Tran_CN_split.getspit(worrywords.get(0).getTranCN()));
                radioThree.setText(Tran_CN_split.getspit(word.getTranCN()));
                radioFour.setText(Tran_CN_split.getspit(worrywords.get(2).getTranCN()));
                break;
            case 3:
                radioOne.setText(Tran_CN_split.getspit(worrywords.get(2).getTranCN()));
                radioTwo.setText(Tran_CN_split.getspit(worrywords.get(0).getTranCN()));
                radioThree.setText( Tran_CN_split.getspit(worrywords.get(1).getTranCN()));
                radioFour.setText(Tran_CN_split.getspit(word.getTranCN()));
                break;
        }
    }
    ...
    private void setTextColor() {
        ...
        radioOne.setBackgroundColor(Color.parseColor("#00ffffff"));      //将选项的按钮设置为白色
        radioTwo.setBackgroundColor(Color.parseColor("#00ffffff"));     //将选项的按钮设置为白色
        radioThree.setBackgroundColor(Color.parseColor("#00ffffff"));     //将选项的按钮设置为白色
        radioFour.setBackgroundColor(Color.parseColor("#00ffffff"));        //将选项的按钮设置为白色
