...
public class WordRecord {
    ...
    //默认构造方法
    public WordRecord(){             //默认构造方法
        super();
    }

    //定义有参数构造方法，初始化信息实体中的字段
    public WordRecord(int wordId, int isFalse, int isFlag, int reperaNum, long timeFirst, long timeFinish) {
        this.wordId = wordId;
    ...
    public WordRecord(int id, int wordId, int isFalse, int isFlag, int reperaNum, long timeFirst, long timeFinish) {
        this._id=id;
        this.wordId = wordId;
        this.isFalse = isFalse;
        this.isFlag = isFlag;
